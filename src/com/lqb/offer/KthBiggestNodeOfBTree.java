...
public class KthBiggestNodeOfBTree {
    ...
    public static void main(String[] args) {
        ...
        TreeNode node = test.kthNode(t1, 5);
        node.print();
    }
	...
	int cur = 0;
    private TreeNode kthNodeCore2(TreeNode pRoot, int k) {
        if (pRoot == null) {
            return null;
        }

        TreeNode ans = kthNodeCore2(pRoot.left, k);
        if (ans != null) {
            return ans;
        }
        ...
        return kthNodeCore2(pRoot.right, k);
    }
